...
**Maturity: Emerging** — real model-driven autonomy is promising and still risky in production · *Who decides:* the model decides · *Grounding:* companion repo + research · *Last reviewed:* 2026-06
</div>
...
**the model decides.** _Who makes the structural decision here, the model or your code? To be argued._
