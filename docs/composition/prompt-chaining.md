...
**Maturity: Standard** — decomposition is an accepted default · *Who decides:* a draw — old structure, new reason · *Grounding:* production + research
</div>
...
**a draw — old structure, new reason.** _Who makes the structural decision here, the model or your code? To be argued._
