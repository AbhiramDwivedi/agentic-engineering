...
**Maturity: Standard** — dispatch is decades-old; *LLM* routing is the newer, narrower thing · *Who decides:* your code decides — NOT agentic routing · *Grounding:* production
</div>
...
**your code decides — NOT agentic routing.** _Who makes the structural decision here, the model or your code? To be argued._
