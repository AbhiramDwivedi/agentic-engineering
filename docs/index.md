...
- **A maturity verdict.** One honest line: is this the accepted default, proven-but-niche, still
...
pattern, contribute a use case, sharpen a verdict, or correct an error. One maintainer reviews
and merges everything. What's non-negotiable is the discipline, not the conclusions: every
contribution carries a maturity verdict and cites its evidence. [Contributing →](contributing.md)
