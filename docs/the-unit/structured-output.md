...
**Maturity: Standard** — a settled capability you should default to · *Who decides:* a feature, not a pattern · *Grounding:* production + research
</div>
...
**a feature, not a pattern.** _Who makes the structural decision here, the model or your code? To be argued._
