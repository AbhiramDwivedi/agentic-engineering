...
**Maturity: Standard** — retry & graceful degradation are standard resilience engineering · *Who decides:* your code decides · *Grounding:* production
</div>
...
**your code decides.** _Who makes the structural decision here, the model or your code? To be argued._
