...
- [3.2 Routing & Dispatch](../composition/the-router-that-isnt.md), the dispatcher deflation in full: why a dispatch table is not Anthropic's Routing.
