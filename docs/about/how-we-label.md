...
For you, the reader: the lens tells you how hard to lean on what follows, and the citation
...
It's also a [contribution rule](../contributing.md). Every pull request carries a maturity lens
